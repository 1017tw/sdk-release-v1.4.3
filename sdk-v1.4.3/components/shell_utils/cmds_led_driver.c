...
void led_driver(int argc, char *argv[]) 
{
    ...
    if (strncmp(argv[1], "init", 4) == 0) {
        ...
        led_set_current(led_dev, CHANNEL_1, current_value_ma);
    } 
        ...
        led_set_current_level(led_dev, CHANNEL_1, value);
    }
        ...
        led_set_timeout(led_dev, CHANNEL_1, value);
    }
    else {
        led_driver_help();
    }
